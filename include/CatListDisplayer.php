...
class CatListDisplayer {
	...
	private function lcp_build_post($single, $tag){
		...
		private function get_post_title($single, $tag = null, $css_class = null){
			...
			if($this->catlist->get_thumbnail($single)){

			} else {

				$info = '<span class="dropt"><a class="modalbox" href="#inline'.$single->ID.'">' .

					$single->post_title . '</a><span><table width="200px" border="0" cellspacing="0" cellpadding="0">
  <tr>
