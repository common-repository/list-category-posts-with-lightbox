...
Plugin Name: List members posts with lightbox- Template

Plugin URI: 

Description: Template file for List members posts with lightbox Plugin for Wordpress which is used by plugin by argument template=value.php
...
include 'fancybox/jquery.fancybox.js?v=2.0.6';
